...
from .services.snapshot_quotes import start_background_task, stop_background_task
from .routes import quotes_snapshot as quotes_snapshot_routes
...
# Include routers
app.include_router(quotes_snapshot_routes.router)
